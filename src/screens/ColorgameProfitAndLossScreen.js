...
import { fetchProfitLossByMarketCg } from '../services/authService.js';
  ...
  const renderItem = ({ item, index }) => (
    <View style={[
      ...
      <View style={styles.row}>
        ...
        <Text style={styles.sportValue}>{item.gameName || gameName}</Text>
      </View>
      <View style={styles.row}>
      ...
      <View style={styles.row}>
        ...
        {renderProfitLossValue(item.totalProfitLoss)}
      </View>
      <View style={styles.row}>
